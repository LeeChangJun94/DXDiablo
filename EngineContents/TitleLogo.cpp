...
ATitleLogo::ATitleLogo()
{
	...
	//LogoRenderer->CreateAnimation("Idle", "Warrior in Heavy Armor (Weaponless)_Idle_Town.png", 0, 10, 0.1f);
	//{
	...
	//LogoRenderer->CreateAnimation("Move", "Warrior in Heavy Armor (Weaponless)_Walk_Town.png", 0, 7, 0.3f);
