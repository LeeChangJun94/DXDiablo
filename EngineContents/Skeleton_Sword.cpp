...
ASkeleton_Sword::ASkeleton_Sword()
{
	...
	Skeleton_SwordRenderer->CreateAnimation("Idle_2", "Skeleton with Sword & Shield_Idle.png", 0, 22, 0.1f);
	Skeleton_SwordRenderer->CreateAnimation("Idle_1", "Skeleton with Sword & Shield_Idle.png", 23, 45, 0.1f);
	Skeleton_SwordRenderer->CreateAnimation("Idle_4", "Skeleton with Sword & Shield_Idle.png", 46, 68, 0.1f);
	Skeleton_SwordRenderer->CreateAnimation("Idle_7", "Skeleton with Sword & Shield_Idle.png", 69, 81, 0.1f);
	Skeleton_SwordRenderer->CreateAnimation("Idle_8", "Skeleton with Sword & Shield_Idle.png", 82, 104, 0.1f);
	Skeleton_SwordRenderer->CreateAnimation("Idle_9", "Skeleton with Sword & Shield_Idle.png", 105, 127, 0.1f);
	Skeleton_SwordRenderer->CreateAnimation("Idle_6", "Skeleton with Sword & Shield_Idle.png", 128, 150, 0.1f);
	Skeleton_SwordRenderer->CreateAnimation("Idle_3", "Skeleton with Sword & Shield_Idle.png", 151, 173, 0.1f);
